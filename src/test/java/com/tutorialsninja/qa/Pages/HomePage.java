...
public class HomePage {
	...
	private WebElement myAccountIcone;
	
	@FindBy (xpath = "//span[normalize-space()='Shopping Cart']")
	WebElement shoppingCartIcone;
	...
	public void selectLoginOption() {
	 ...
	 public SearchPage clickOnSearchIcone() {
		 ...
		 public boolean myAccountIconeAvailable() {
			boolean  displayStatus = myAccountIcone.isEnabled();
			 return displayStatus;
		 
	 }
		 
		 public void clickOnShoppingCart() {
		 shoppingCartIcone.click();
